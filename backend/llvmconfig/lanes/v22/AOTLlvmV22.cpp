// backend/llvmconfig/lanes/v22/AOTLlvmV22.cpp
...
namespace parus::backend::aot::detail {
    ...
    /// @brief LLVM 22 lane 전용 OIR -> LLVM-IR emission 구현.
    CompileResult compile_llvm_lane_v22(
        ...
        const auto lowered = lower_oir_to_llvm_ir_text(
            oir,
            types,
            LLVMIRLoweringOptions{.llvm_lane_major = 22}
        );
