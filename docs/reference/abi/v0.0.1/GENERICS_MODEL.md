...
1. OOP/다형성 의미 충돌 시 `docs/reference/abi/v0.0.1/OOP_MODEL.md` 우선
2. ABI 경계 의미 충돌 시 `docs/reference/abi/v0.0.1/ABI.md` 우선
3. 일반 언어 표면 문법 충돌 시 `docs/reference/language/SPEC.md` 갱신을 통해 정합화
