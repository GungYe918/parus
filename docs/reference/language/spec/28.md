...
```ebnf
FieldDecl     := "field" FieldLayoutOpt FieldAlignOpt Ident GenericParamClauseOpt BlockField ;
...
4. `field Name<T> ...` 구문은 파서에서 인식되더라도 v1에서는 `GenericFieldNotSupportedV1`로 거부한다.
