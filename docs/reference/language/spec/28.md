...
CompilerIntrinsicDecl := "$" "!" "[" DirectivePath "=" DirectivePath "]" ";" ;
...
9. `$![...]`는 현재 단계에서 **파싱/AST 보존만** 수행하며 intrinsic 등록 의미론은 후속 단계에서 확정한다.
10. 매크로 호출 `$path(...)`와 compiler 지시문 `$[...]`, `$![...]`는 구문 계층이 다르며 상호 대체되지 않는다.
