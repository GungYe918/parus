...
ProtoDecl     := ExportOpt "proto" Ident ProtoInheritOpt BlockProto ProtoRequireTail ";" ;
...
ProtoRequireTail := "with" "require" "(" SimpleBoolExpr ")" ;
SimpleBoolExpr := BoolTerm ("||" BoolTerm)* ;
BoolTerm      := BoolFactor ("&&" BoolFactor)* ;
BoolFactor    := "true" | "false" | "!" BoolFactor | "(" SimpleBoolExpr ")" ;

TabletDecl    := ExportOpt "class" Ident InheritOpt BlockTablet ;
