...
1. generic class/proto/acts를 common monomorphization service로 옮기는 작업
2. external generic type/class/proto/acts body import 설계 및 activation 범위 결정
3. typed template payload dependency closure를 free-function-only에서 더 넓힐지 검토
