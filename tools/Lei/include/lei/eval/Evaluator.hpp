...
struct Value {
    ...
    std::variant<int64_t, double, std::string, bool, Object, Array, Function> data;
...
class Evaluator {
public:
    Evaluator(EvaluatorBudget budget, diag::Bag& diags)
        : budget_(budget), diags_(diags) {}
...
private:
    ...
    Value make_intrinsic_base() const;
