// tools/gaupelc/src/cli/Options.cpp
#include "Options.hpp"
...
namespace gaupelc::cli {
    ...
    namespace {
        ...
        /// @brief `--lang` 옵션을 파싱한다.
        gaupel::diag::Language parse_lang(const std::vector<std::string_view>& args) {
        ...
        gaupel::passes::ShadowingMode parse_shadowing_mode(const std::vector<std::string_view>& args) {
