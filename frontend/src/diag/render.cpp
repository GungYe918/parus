...
namespace parus::diag {
    ...
    static std::string_view code_name_sv_(Code c) {
        switch (c) {
            ...
            case Code::kProtoRequireMissing: return "ProtoRequireMissing";
    ...
    static std::string template_en(Code c) {
        switch (c) {
            ...
            case Code::kProtoMemberBodyNotAllowed: return "proto member declarations must not have a body";
            case Code::kProtoOperatorNotAllowed: return "operator declarations are not allowed in proto";
            case Code::kProtoRequireMissing: return "proto declaration requires tail clause: with require(<bool-expr>)";
            case Code::kProtoRequireTypeNotBool: return "require(...) expression must have type bool";
            case Code::kProtoRequireExprTooComplex: return "require(...) supports only simple boolean expressions (true/false/!/&&/||/parentheses) in v1";
    ...
    static std::string template_ko(Code c) {
        switch (c) {
            ...
            case Code::kProtoMemberBodyNotAllowed: return "proto 멤버 선언에는 본문을 둘 수 없습니다";
            case Code::kProtoOperatorNotAllowed: return "proto 내부에서는 operator 선언을 사용할 수 없습니다";
            case Code::kProtoRequireMissing: return "proto 선언에는 tail 절 'with require(<bool식>)'이 필요합니다";
            case Code::kProtoRequireTypeNotBool: return "require(...) 식의 타입은 bool이어야 합니다";
            case Code::kProtoRequireExprTooComplex: return "v1에서 require(...)는 단순 bool 식(true/false/!/&&/||/괄호)만 허용됩니다";
